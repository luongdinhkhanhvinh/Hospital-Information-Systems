...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 22, 2019 lúc 03:44 PM
...
--
-- Đang đổ dữ liệu cho bảng `diagnosis`
--
...
--
-- Đang đổ dữ liệu cho bảng `growth`
--
...
CREATE TABLE `patients` (
  ...
  `married` varchar(256) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `dor` date DEFAULT NULL,
  `contact` varchar(256) DEFAULT NULL,
  `referred` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
(16, 'Lê', 'Thừa', '2019-01-01', 'đức hòa hạ,đức hòa,long an', 'Độc thân', '2019-07-11', '0123456789', 'Bệnh viện quận 1', 'Không có khả năng chuyển');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `requisitions`
--
...
--
-- Đang đổ dữ liệu cho bảng `requisitions`
--
...
(1, 'khanhvinh15@gmail.com', '123', 'admin'),
(2, 'khanhvinh1@gmail.com', '1234', 'user'),
(3, 'khanhvinh12@gmail.com', 'q', 'admin');
