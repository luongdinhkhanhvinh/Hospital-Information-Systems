                        ...
                        <div class="card-body">
                            <form action="#" class="login" id="login">
                                ...
                                <div class="form-header blue-gradient">
                                    <h3><i class="fa fa-user mt-2 mb-2"></i> Đăng nhập:</h3>
                                </div>
                                ...
                                <div class="md-form">
                                    ...
                                    <label for="orangeForm-pass">Mật khẩu của bạn</label>
                                </div>

                                <div class="text-center">
                                    <button onclick="submitForm()" class="btn blue-gradient btn-lg">Đăng nhập</button>
                                    <hr>
