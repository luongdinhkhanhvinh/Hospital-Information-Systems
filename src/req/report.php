...
<div class="container">
    <?= $jumbo->getJumbo("Xem báo cáo yêu cầu", "Xem yêu cầu báo cáo thuốc") ?>
    ...
    <form method="get">
        ...
        <div class="row">
            ...
            <div class="col-3">
                <input class="btn btn-default btn sm" type="submit" value="Tìm kiếm">
            </div>
        </div>
    </form>
    <input class="btn btn-sm btn-default" onclick="refresh()" value="Xóa">
    <br>
