...
<div class="container">
    <?= $jumbo->getJumbo("Kiểm tra tên", "Thêm kiểm tra chuẩn đoán bệnh nhân") ?>
    <form method='POST' role='form' class="addTest" action='#' onsubmit="addTest()">
        <input type="hidden" name="type" value="addTest" id="">
        <div class='form-group'>
            <label for='in_TestName'>Kiểm tra tên</label>
            <input name='in_TestName' placeholder='Kiểm tra tên' id='in_TestName' class='form-control' type='text' required>
        </div>
        <div class='form-group'>
            <label for='in_Result'>Kết quả</label>
            <input name='in_Result' id='in_Result' class='form-control' type='text' placeholder='Kết quả' required>
        </div>
        <div class='form-group'>
